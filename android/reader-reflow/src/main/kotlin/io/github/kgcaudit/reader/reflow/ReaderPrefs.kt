...
data class ReaderPrefs(
    ...
    /** 듣기(4단계). 조판과 상관없다 — LayoutSpec 에 넣지 않는다. */
    val listen: ListenPrefs = ListenPrefs(),
) {
    ...
    /**
     * 좌우 여백(dp). 0.13.1 에서 한 칸씩 넓혔다(사용자 요청): 좁게 = 옛 보통(24), 보통 = 옛 넓게(36), 넓게 = 같은
     * 폭(12dp)을 더 준 48. 16dp 에서는 휴대폰의 카메라 구멍(펀치홀)이 가로 화면에서 줄 첫 글자를 가렸다.
     */
