...
./gradlew :app:assembleRelease                # → app/build/outputs/apk/release/OLO-eBook-0.15.1-devkey-release.apk  (비공개 키가 있으면 -devkey 없음)
